...
const TYPE_ORDER = ['ag', 'arca', 'arcf'];

const TYPE_LABELS = {
  ag:         'Assembleia Geral',
  arca:        'Ata Reunião do Conselho de Administração',
  arcf:        'Ata Reunião do Conselho Fiscal',
};

const DOCS = [
  // 2026
  { year: 2026, type: 'ag',        title: 'Ata da Assembleia Geral Ordinária e Extraordinária',                                                         date: '14 Mai 2026', size: '2,1 MB' },
  { year: 2026, type: 'arca',         title: 'Ata da 308ª RCA',                                       date: '29 Mai 2026', size: '4,8 MB' },
  { year: 2026, type: 'arcf',         title: 'Ata da Reunião do Conselho Fiscal',                             date: '15 Jan 2026', size: '0,4 MB' },
  // 2025
  { year: 2025, type: 'ag',        title: 'Boletim de voto à distância - Assembleia Geral Ordinária',                                                         date: '12 Mai 2025', size: '1,8 MB' },
  { year: 2025, type: 'ag',        title: 'Manual de Participação - Assembleia Geral Ordinária e Extraordinária',                                                         date: '11 Ago 2025', size: '1,9 MB' },
  { year: 2025, type: 'arca',        title: 'Ata da 307ª RCA',                                                         date: '10 Nov 2025', size: '2,0 MB' },
  { year: 2025, type: 'arcf',        title: 'Ata da 9ª Reunião do Conselho Fiscal',                   date: '12 Fev 2025', size: '3,5 MB' },
  { year: 2025, type: 'arcf',         title: 'Ata da 8ª Reunião do Conselho Fiscal',                                       date: '30 Mai 2025', size: '4,5 MB' },
];
...
let _uid = 0;
function uid() { return `acc-atas-assembleias-${++_uid}`; }
...
function renderList(year) {
  const container = document.querySelector('[data-atas-assembleias-list]');
  if (!container) return;
...
document.addEventListener('DOMContentLoaded', () => {
  const sel = document.querySelector('[data-atas-assembleias-year]');
